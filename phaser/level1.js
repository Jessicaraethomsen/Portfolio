...
var level1 = {
		...
		create: function () {
			...
			scoreText = game.add.text(16, 16, '', { fontSize: '20px', fill: '#fff' });
			
			//create SCORE
			score1 = '';
			scoreTxt = this.add.text(16, 40, score1.toString(), { fontSize: '20px', fill: '#fff'});
